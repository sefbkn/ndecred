    ...
    public partial class ScriptEngine
    {
        ...
        private void InitializeOpCodeDictionary()
        {
            var collection = new (OpCode op, Action<ParsedOpCode> action)[]
            {
                ...
                (OpCode.OP_BOOLAND           , e => throw new NotImplementedException()),
                (OpCode.OP_BOOLOR            , e => throw new NotImplementedException()),
                (OpCode.OP_NUMEQUAL          , e => throw new NotImplementedException()),
                (OpCode.OP_NUMEQUALVERIFY    , e => throw new NotImplementedException()),
                (OpCode.OP_NUMNOTEQUAL       , e => throw new NotImplementedException()),
                (OpCode.OP_LESSTHAN          , e => throw new NotImplementedException()),
                (OpCode.OP_GREATERTHAN       , e => throw new NotImplementedException()),
                (OpCode.OP_LESSTHANOREQUAL   , e => throw new NotImplementedException()),
                (OpCode.OP_GREATERTHANOREQUAL, e => throw new NotImplementedException()),
                (OpCode.OP_MIN               , e => throw new NotImplementedException()),
                (OpCode.OP_MAX               , e => throw new NotImplementedException()),
                (OpCode.OP_WITHIN            , e => throw new NotImplementedException()),
                (OpCode.OP_RIPEMD160         , e => throw new NotImplementedException()),
                (OpCode.OP_SHA1              , e => throw new NotImplementedException()),
                (OpCode.OP_BLAKE256          , e => throw new NotImplementedException()),
                (OpCode.OP_HASH160           , e => throw new NotImplementedException()),
                (OpCode.OP_HASH256           , e => throw new NotImplementedException()) 
            };
